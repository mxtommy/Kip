...
describe('GestureDirective', () => {
  ...
  beforeEach(async () => {
    ...
    const gestureStatics = GestureDirective as unknown as {
      ...
      _laneOwners?: Map<number, { h?: number; v?: number; p?: number }>;
      _activePointers?: Set<number>;
      _multiPointerActive?: boolean;
    };
    if (gestureStatics._suppressAllGesturesUntil !== undefined) gestureStatics._suppressAllGesturesUntil = 0;
    if (gestureStatics._laneOwners) gestureStatics._laneOwners.clear();
    if (gestureStatics._activePointers) gestureStatics._activePointers.clear();
    if (gestureStatics._multiPointerActive !== undefined) gestureStatics._multiPointerActive = false;
